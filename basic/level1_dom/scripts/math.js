...
const adDB = [{
    name:'밀키스',//alt
    src:'https://i.pinimg.com/736x/6d/1e/36/6d1e361917835451ca2073a714196a71.jpg',
    link:'https://naver.com',
},{
    name:'모구모구',
    src:'https://i.pinimg.com/1200x/2b/0c/c8/2b0cc85d319a28d348553ee00617941e.jpg',
...
priceBtn.addEventListener('click',()=>{
    ...
    console.log(Math.min(...priceMap2))
    result1.textContent = '최저가 ' +Math.min(...priceMap2) +'원';
...
deliveryBtn.addEventListener('click',()=>{
    ...
    result2.textContent = '배송비 ' +Math.min(...priceMap2) +'원';
})
